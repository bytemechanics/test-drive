 ...
 * @since 0.4.0
 */
public class DrivenTestInstanceParametersNotMatch extends DrivenTestException{
	 ...
	 */
	public DrivenTestInstanceParametersNotMatch(final EvaluationId _evaluation,final Object[] _provided,final Throwable _cause) {
		super("Driven test {} can not be instantiated.",SimpleFormat.format("Has not the necessary parameters.\n\t\tExpected: {}\n\t\tFound: {}",_evaluation.getTestMethod().getParameterTypes(),_provided), _evaluation,_cause);
	...
	public boolean equals(Object obj) {
		if (super.equals(obj)) {
			final DrivenTestInstanceParametersNotMatch other = (DrivenTestInstanceParametersNotMatch) obj;
